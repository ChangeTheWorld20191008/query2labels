...
category_map = {
    ...
    "82": 73, "84": 74, "85": 75, "86": 76, "87": 77, "88": 78, "89": 79,
    "90": 80}
...
class CoCoDataset(data.Dataset):
    def __init__(self, image_dir, anno_path, input_transform=None,
                 labels_path=None,
                 used_category=-1):
        self.coco = CocoDetection(root=image_dir, annFile=anno_path)
        ...
        if os.path.exists(self.labels_path):
            ...
            print(
                "No preprocessed label file found in {}.".format(
                    self.labels_path))
